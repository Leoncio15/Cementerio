...
public class frmEditarDifunto extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmEditarDifunto frame = new frmEditarDifunto();
	...
	public frmEditarDifunto() {
		...
		JLabel lblNewLabel = new JLabel("EDITAR DIFUNTO");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblNewLabel.setBackground(new Color(255, 255, 255));
		lblNewLabel.setBounds(279, 62, 215, 30);
		...
		txtCedula_Difunto.setEditable(false);
		...
		btnGuardar_Difunto = new JButton("EDITAR");
		...
		CalendarFechaFallecimieto_Difunto.setBounds(308, 362, 254, 31);
		contentPane.add(CalendarFechaFallecimieto_Difunto);
		
		CalendarFechaNacimieto_Difunto = new JDateChooser();
		CalendarFechaNacimieto_Difunto.setBounds(309, 426, 253, 31);
